...
begin
	...
	FA_parameter_guess = [0.1, 0.12, 0.13, 0.14, 0.15, 0.16, 0.5, 0.5] 
	...
	RhoA_FA_prob = ODEProblem(RhoA_FA_model, 
		...
		(150.0, 400.0), 
		FA_parameter_guess[1:6], jac = true)
end
...
function FA_MSE_loss(new_parameters)
	...
	new_GEF0 = new_parameters[7]
	new_GAP0 = new_parameters[8]
	new_u0 = [new_GEF0; new_GAP0; 1]
	new_p = new_parameters[1:6]       # (it performs a deep copy)
...
begin
	...
	FA_lower_b = repeat([0], 8)
	FA_upper_b = [repeat([10], 6); 2; 2]
...
begin
	...
	GEF0 = FA_optim_results.u[7]
	GAP0 = FA_optim_results.u[8]
	FA_pred_u0 = [GEF0; GAP0; 1]

	# Re-modify parameters as for optimisation
	FA_pred_p = FA_optim_results[1:6]
...
begin
	...
	saved_FA_param = [
		...
		RhoA_FA_model.GEF0 => saved_FA_parameters[7],
		RhoA_FA_model.GAP0 => saved_FA_parameters[8]
	]
	saved_FA_u0 = [saved_FA_parameters[7:8]; 1]
