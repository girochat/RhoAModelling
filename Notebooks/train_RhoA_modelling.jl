...
# ╔═╡ 594d0214-dfbc-11ee-3d95-538109c4b54a
using Plots, PlutoUI, DifferentialEquations, StructuralIdentifiability, ModelingToolkit
...
@mtkmodel RhoA_linear_dynamics begin
	...
	@equations begin
		#S ~ f_tanh(t)
		D(aRhoA) ~ steady * Kinact_Rho - Kinact_Rho * aRhoA 
		y ~ aRhoA
	end
end
...
@mtkmodel RhoA_GAP_FL_dynamics begin
	...
	@equations begin
		...
		D(aGAP) ~ Kcat_FL*((10 - aGAP) * aRhoA^n)/(Km_FL + (10 - aGAP)) - Kinact_GAP * aGAP
...
@bind GAP_FL_parameters parameter_input([
	...
	("Km_aGEF", 0.1, 1, 0.4),
	("Kcat_aGAP", 0.00001, 0.001, 0.0005),
	("Km_aGAP", 0.1, 1, 0.8),
	("n", 1, 10, 1)
])
...
begin
	GAP_FL_prob = ODEProblem(RhoA_GAP_FL_model, 
		[RhoA_GAP_FL_model.aGEF => 0.5, 
			RhoA_GAP_FL_model.aRhoA => 1,
			RhoA_GAP_FL_model.aGAP => 1], 
		(0.0, 350.0), 
...
ModelingToolkit = "~9.4.0"
Plots = "~1.40.2"
PlutoUI = "~0.7.58"
StructuralIdentifiability = "~0.5.5"
"""
...
manifest_format = "2.0"
project_hash = "e7b89baaa3e41b655fd5404bd746981fa21b8462"
...
git-tree-sha1 = "c5b67f9b65fa3462d8fba699b0afc4a5ec11d007"
...
git-tree-sha1 = "bd77385a0fc00ca65d69f55e41955b07ff0dd366"
...
git-tree-sha1 = "042608040d4816df966e92566d3e015e291dfa6d"
...
git-tree-sha1 = "1763cf243494de35378b46c73c4f53b2240770f8"
...
git-tree-sha1 = "3789515efc803d7d37c3bad18a4b48d1b34196b7"
...
git-tree-sha1 = "2a0ba5470e9ecef02d088224abfd9e82c6b1cb6b"
...
git-tree-sha1 = "e56777e3aebc8d540cedb0d9e9c81da8669bf433"
uuid = "220ca800-aa68-49bb-acd8-6037fa93a544"
version = "0.5.5"
weakdeps = ["ModelingToolkit", "SymbolicUtils", "Symbolics"]

    [deps.StructuralIdentifiability.extensions]
...
git-tree-sha1 = "a78c26337d325f3818defeb8893280bbdd461279"
