...
begin
	...
	parameter_guess = [0.1, 0.12, 0.13, 0.14, 0.15, 0.16, 0.5, 0.5]
...
begin
	...
	GEF0 = optim_results.u[7]
	GAP0 = optim_results.u[8]
	pred_u0 = [GEF0; GAP0; 1]

	# Re-modify parameters as for optimisation
	pred_p = optim_results[1:6]
...
begin
	...
	saved_param = [
		...
		RhoA_model.GEF0 => saved_parameters[7],
		RhoA_model.GAP0 => saved_parameters[8]
	]
