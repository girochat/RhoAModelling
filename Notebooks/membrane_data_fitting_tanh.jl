...
@mtkmodel RhoA_dynamics begin
	...
	@equations begin
		...
		D(aRhoA) ~  Kcat_aGEF * (aGEF - GEF0) * (10 - aRhoA)/(5 + (10 - aRhoA)) - Kcat_aGAP * (aGAP - GAP0) * (aRhoA)/(Km_aGAP + (aRhoA))
		S ~ f_tanh(t)
	end
end
...
begin
	...
	parameter_guess = [0.1, 0.12, 0.13, 0.14, 0.15, 0.16, 0.17, 0.18, 0.5, 0.5]
	...
	RhoA_prob = ODEProblem(RhoA_model, 
		[RhoA_model.aGEF => 0.5, 
			RhoA_model.aRhoA => 1,
			RhoA_model.aGAP => 0.5], 
		(150.0, 400.0), parameter_guess[1:8], jac = true)
end
...
begin
	...
	GEF0 = optim_results.u[9]
	GAP0 = optim_results.u[10]
	pred_u0 = [GEF0; GAP0; 1]

	# Re-modify parameters as for optimisation
	pred_p = optim_results[1:8]
...
begin
	...
	saved_parameters = [0, 0.0323253, 5.00065, 1.21834, 0.0112742, 0.040463, 4.99964, 4.99641, 0.245986, 0.999585]
...
function KO_MSE_loss(new_parameters)
	...
	new_p[get_idxparam(RhoA_KO_model.GEF0, RhoA_KO_prob)] = GEF0_KO 
	new_p[get_idxparam(RhoA_KO_model.GAP0, RhoA_KO_prob)] = GAP0_KO 
...
begin
	# Save best parameters
	saved_KO_parameters = [0, 0.0153623, 5.0012, 5.21097, 0.0335713, 0, 5.01001, 0.320935, 0.889598] #[0, 0.0146862, 5.00088, 5.01372, 0.0325615, 0, 4.99994, 0.350805, 0.891507]#[0, 0.0193631, 5.0066, 5.01481, 0.00460812, 0, 5.0, 0.358392, 0.890286]
